    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-have-started-working-as-a-graduate-student-researcher-at-lara",
          title: 'I have started working as a Graduate Student Researcher at LARA',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Jeanine_s_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=N5tnkrQAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
